...
<div class="container" style="margin-top:65px">
        ...
        <div class="jumbotron text-center">
            <h1>Welcome to BENEMART!!</h1>
            <p>We have all you need at one place</p>
        </div>
        <!--jumbutron ends-->
        <!--breadcrumb start-->
    ...
    <div class="row text-center" id="watch">
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/images (1).jpg" alt="" class="img-fluid pb-1" >
    ...
    <div class="row text-center" id="shirt">
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="images/images (4).jpg" alt="" class="img-fluid pb-1"  >
                    <div class="figure-caption">
                    <h6>Levi's Watch</h6>
                    <h6>Price :Rs 2800</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    <img src="images/images (5).jpg" alt="" class="img-fluid pb-1" >
                    <div class="figure-caption">
        ...
        <div class="row text-center" id="shoes" >
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/images (7).jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Nike Sneaker</h6>
                            <h6>Price :Rs 8000</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/images (8).jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Adidas Shoes</h6>
                            <h6>Price :Rs 7500</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/images (9).jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Gucci Sneaker</h6>
                ...
                <div class="col-md-3 col-6 py-3" >
                    <div class="card">
                        <img src="images/images (10).jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                        <h6>Nike Shoes</h6>
                    <h6>Price :Rs 24000</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    } else {
